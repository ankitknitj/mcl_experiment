...
def grid_trials_exp3():
    ...
    yield {
        **grid_unreward(3),
        'centerMessage': '<b>Unrewarded decisions (Scarcity)</b>',
        'edgeDisplay': False,
        'stateDisplay': False,
        'stateClickCost': 0,
...
def grid_trials_exp1():
    ...
    yield {
        **grid(3),
        'centerMessage': '<b>Misalignment metric (Low performance contingency) - Low Click Cost</b>',
        'edgeDisplay': False,
        'stateDisplay': 'click',
        'stateClickCost': 1,
...
def grid_trials_exp1_high_cost():
    ...
    yield {
        **grid(3),
        'centerMessage': '<b>Misalignment metric (Low performance contingency) - High Click Cost</b>',
        'edgeDisplay': False,
        'stateDisplay': 'click',
        'stateClickCost': 5,
        'playerImage': 'static/images/spider.png'
